...
const Cart = () => {
  // const {producto, removeItem, clearItem} = useContext(MyContext)
  return (
    <>
    {/* {
      Cart.length > 0
                 ...
                 <div className="cart_container">
                             ...
                             <li className="cart_item clearfix">
                                 ...
                                 <div className="cart_item_info d-flex flex-md-row flex-column justify-content-between">
                                     <div className="cart_item_name cart_info_col">
                                         <div className="cart_item_title"> Producto: {title}</div>
                                         <div className="cart_item_text"></div>
                                     </div>
                                     <div className="cart_item_color cart_info_col">
                                         <div className="cart_item_title"></div>
                                         <div className="cart_item_text"><span style="background-color:#999999;"></span>Silver</div>
                                     </div>
                                     ...
                                     <div className="cart_item_price cart_info_col">
                                         <div className="cart_item_title">Precio: $ {price}</div>
                                         <div className="cart_item_text"></div>
                                     </div>
                     ...
                     <div className="order_total">
                         <div className="order_total_content text-md-right">
                             <div className="order_total_title">Compra Total:</div>
